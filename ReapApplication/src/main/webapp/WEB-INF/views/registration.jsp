...
<br/>
 ...
 <form class="form-horizontal" modelAttribute="regform" data-toggle="validator" role="form" name="regform" id="regform" class="form-control" action="" method="POST">
<fieldset>
...
<div class="form-group has-feedback">
  ...
  <div class="col-md-6">
  <input id="number" name="number" type="text" pattern="^[_0-9]{1,}$" data-minlength="10" maxlength="10" placeholder="Enter Mobile Number" data-error="Please Enter Valid Mobile Number" class="form-control input-md" required>
    <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
   <div class="help-block with-errors"></div>
  </div> 
  </div>
