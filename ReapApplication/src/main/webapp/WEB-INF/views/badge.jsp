  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="reapnavbar">
      <ul class="nav navbar-nav navbar-right" style="font-size:18px;color:#000">
                <li class="buttons"><a href="index.html"><img src="/reap/resources/img/ico-dashboard.png" />
                        Dashboard
                    </a> </li>

					<li class="buttons"><a href="badge.html"><img src="/reap/resources/img/ico-badge.png" />
                        Badges
                    </a>
                </li>
		        <li class="buttons">
           <a href="#" data-toggle="modal" data-target="#myModal" data-backdrop="static" data-keyboard="false">
		   <img src="/reap/resources/img/ico-badge.png" />Divyansh</a>
          </ul>
        </li>
      </ul>
    </div>
...
<div class="modal" id="myModal" role="dialog">
    <div class="modal-dialog">
      ...
      <div class="modal-content">
		...
		<center>
		<img src="/reap/resources/img/Divyansh.png" name="aboutme" width="190" height="190" border="0" class="img-rounded">
		</center>
		<br/>
		<div class="row">
                                <div class="col-md-12">
    ...
    <div class="col-md-4">
      ...
      <div class="panel-heading" style="background:#8d9fc4; color:#ffffff" ><img src="/reap/resources/img/ico-badge.png" /> <strong style="font-size:15px" >&nbsp
	  BADGES & POINTS
	  </strong></div>
	  ...
	  <div class="row">
			...
			<div class="col-xs-4"><img class="img-rounded" src="/reap/resources/img/ico-badge-orange.png" /></div>
			<div class="col-xs-4"><img class="img-rounded" src="/reap/resources/img/ico-badge-grey.png" /></div>
			<div class="col-xs-4"><img class="img-rounded" src="/reap/resources/img/ico-badge-brown.png" /></div>
			</div>
			<div class="row" style="padding-top:5px">
        ...
        <img src="/reap/resources/img/points.png" alt="Points" class="img-rounded">
