...
<form class="form-horizontal" id="loginform" class="form-control" name="loginform" data-toggle="validator" role="form" action="" method="POST">
...
<br/>
<br/>
Not a Member !! <a href="registration.html"style="font-size:17px">Register Now</a>
